...
import { Search, Filter, Plus, Mail, Phone, Shield, UserCheck, UserX } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage department personnel and their roles
          </p>
        </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {member.primary_station && (
                    <p className="text-xs text-gray-500 mt-1">
                      {(member.primary_station as any).name}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-4">
                {member.email && (
                  <a
                    ...
                    className="flex items-center gap-1 text-sm text-gray-500 hover:text-fire-600"
                  >
